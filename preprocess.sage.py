...
# This file was *autogenerated* from the file preprocess.sage
from sage.all_cmdline import *   # import sage library

_sage_const_15 = Integer(15); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_300 = Integer(300); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3)#from sage.rings.polynomial.pbori import *
...
def print_conversion(clauses, functions):
    ...
    for c, f in zip(clauses, functions):
        c = str(c)
        f = str(f)
        print(c.ljust(_sage_const_15 , " "), " <-> ", f)
...
def construct_graph(clauses, m):
    ...
    for i in range(_sage_const_0 , n_clauses):
...
def plot_graph(G):
    ...
    plt.savefig('plotgraph.png', dpi=_sage_const_300 , bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    ...
    clauses = [[int(n) for n in line.split() if n != '0'] for line in in_data if line[_sage_const_0 ] not in ('c', 'p')]
    ...
    G, reps_set, T = build_blocks(_sage_const_2 , plot=False)
    ...
    for i, rep in enumerate(reps_set):
    	...
    	with open(data_path + str(i).zfill(_sage_const_3 ), "wb") as f:
    		f.write(data)
